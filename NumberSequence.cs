...
namespace LV5
{
    class NumberSequence
    {
        ...
        private Pretrazivanja pretrazivanja;
        private int trazeniBroj = 2;
        ...
        public void SetPretrazivanje(Pretrazivanja pret) {
            this.pretrazivanja = pret;
        }
        public void pretr() { this.pretrazivanja.find(this.sequence, this.trazeniBroj); }
